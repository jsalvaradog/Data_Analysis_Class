...
def main(args):
    ...
    pt.to_conventions()
    points =  [th_KM15.ReH(pt), th_KM15.ImH(pt), th_KM15.ReE(pt), th_KM15.ImE(pt), th_KM15.ReHt(pt), th_KM15.ImHt(pt), th_KM15.ReEt(pt), th_KM15.ImEt(pt)]
    points2 = [float(x) for x in points]
 
    return points2  # This will work
    #pt.xi = 0.0135
    #pt.xip= -0.012
    #print(pt.xi, pt.xip)
