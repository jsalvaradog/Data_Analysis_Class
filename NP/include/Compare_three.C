void BDT::Compare_three(TCut cut, TString Data1, TString Data2){
  ...
  double factor=1;
  TH1F *hist1c_3 = new TH1F("hist1c_3","#bf{k}'(GeV)",100,0,7);
  TH1F *hist2c_3 = new TH1F("hist2c_3","#bf{q}'(GeV)",100,2,10);
  TH1F *hist3c_3 = new TH1F("hist3c_3","M^{2}_{e#gamma X} (GeV^{2})",100,0,3);
  TH1F *hist4c_3 = new TH1F("hist4c_3","#theta_{e} (deg)",100,5,35);
  TH1F *hist5c_3 = new TH1F("hist5c_3","#theta_{#gamma} (deg)",100,0,35);
  TH1F *hist6c_3 = new TH1F("hist6c_3","#Delta t (GeV^{2})",100,-0.2,0.4);  
  TH1F *hist7c_3 = new TH1F("hist7c_3","#phi_{e} (deg)",100,-180,180);
  TH1F *hist8c_3 = new TH1F("hist8c_3","#phi (deg)",100,0,360);
  TH1F *hist9c_3 = new TH1F("hist9c_3","t (GeV^{2})",100,-1,0);

  TH1F *hist1c_2 = new TH1F("hist1c_2","#bf{k}'(GeV)",100,0,7);
  TH1F *hist2c_2 = new TH1F("hist2c_2","#bf{q}'(GeV)",100,2,10);
  TH1F *hist3c_2 = new TH1F("hist3c_2","M^{2}_{e#gamma X} (GeV^{2})",100,0,3);
  TH1F *hist4c_2 = new TH1F("hist4c_2","#theta_{e} (deg)",100,5,35);
  TH1F *hist5c_2 = new TH1F("hist5c_2","#theta_{#gamma} (deg)",100,0,35);
  TH1F *hist6c_2 = new TH1F("hist6c_2","#Delta t (GeV^{2})",100,-0.2,0.4);
  TH1F *hist7c_2 = new TH1F("hist7c_2","#phi_{e} (deg)",100,-180,180);
  TH1F *hist8c_2 = new TH1F("hist8c_2","#phi (deg)",100,0,360);
  TH1F *hist9c_2 = new TH1F("hist9c_2","t (GeV^{2})",100,-1,0);

  TH1F *hist1c_1 = new TH1F("hist1c_1","#bf{k}'(GeV)",100,0,7);
  TH1F *hist2c_1 = new TH1F("hist2c_1","#bf{q}'(GeV)",100,2,10);
  TH1F *hist3c_1 = new TH1F("hist3c_1","M^{2}_{e#gamma X} (GeV^{2})",100,0,3);
  TH1F *hist4c_1 = new TH1F("hist4c_1","#theta_{e} (deg)",100,5,35);
  TH1F *hist5c_1 = new TH1F("hist5c_1","#theta_{#gamma} (deg)",100,0,35);
  TH1F *hist6c_1 = new TH1F("hist6c_1","#Delta t (GeV^{2})",100,-0.2,0.4);
  TH1F *hist7c_1 = new TH1F("hist7c_1","#phi_{e} (deg)",100,-180,180);
  TH1F *hist8c_1 = new TH1F("hist8c_1","#phi (deg)",100,0,360);
  TH1F *hist9c_1 = new TH1F("hist9c_1","t (GeV^{2})",100,-1,0);


  //Variables to plot
  const char *p1="strip_El_P";
  const char *p2="strip_Ph_P";
  const char *p3="mm2_eg";
  const char *p4="strip_El_Theta";
  const char *p5="strip_Ph_Theta";
  const char *p6="delta_t";
  const char *p7="strip_El_Phi";
  const char *p8="Phi_Ph";
  const char *p9="t_Ph";
