...
public:
  ...
  TCut Mbins[94];  
  TCut Rcuts[94];  
  std::array<std::array<double, 6>, 94> bins;
  std::array<int, 94> Nphibins;
  ...
  { 
    ...
    gROOT->ProcessLine(".L include/Get_Contamination_Fit.C");
    ...
    gROOT->ProcessLine(".L include/Best_BDT.C");
  }
  ...
  TH1F* Phase_Space_Factor1(int NBinsPhi, int bin);
