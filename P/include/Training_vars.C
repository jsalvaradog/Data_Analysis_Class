void BDT::Training_vars(TString Data, TString MC_DVCS, TString MC_Pi0, TCut cut){
  ...
  TH1F *hist1c_SimAdd = new TH1F("hist1c_SimAdd","DVCS + #pi^{0}",100,-0.02,0.02);
  TH1F *hist2c_SimAdd = new TH1F("hist2c_SimAdd","DVCS + #pi^{0}",100,0,3);
  TH1F *hist3c_SimAdd = new TH1F("hist3c_SimAdd","DVCS + #pi^{0}",100,-0.5,0.5);
  TH1F *hist4c_SimAdd = new TH1F("hist4c_SimAdd","DVCS + #pi^{0}",100,-0.2,0.4);
  TH1F *hist5c_SimAdd = new TH1F("hist5c_SimAdd","DVCS + #pi^{0}",100, -0.2,2);
  ...
  double factor=0.64; //Global
  double factor_pi0=1-factor;
  ...
  hist4c_Sim->Scale(factor*hist4c_Data->GetEntries()/hist4c_Sim->GetEntries());
  hist5c_Sim->Scale(factor*hist5c_Data->GetEntries()/hist5c_Sim->GetEntries());

  hist1c_Pi0->Scale(factor_pi0*hist1c_Data->GetEntries()/hist1c_Pi0->GetEntries());
  hist2c_Pi0->Scale(factor_pi0*hist2c_Data->GetEntries()/hist2c_Pi0->GetEntries());
  hist3c_Pi0->Scale(factor_pi0*hist3c_Data->GetEntries()/hist3c_Pi0->GetEntries());
  hist4c_Pi0->Scale(factor_pi0*hist4c_Data->GetEntries()/hist4c_Pi0->GetEntries());
  hist5c_Pi0->Scale(factor_pi0*hist5c_Data->GetEntries()/hist5c_Pi0->GetEntries());
  ...
  hist4c_SimAdd->Add(hist4c_Sim, hist4c_Pi0,1,1);
  hist5c_SimAdd->Add(hist5c_Sim, hist5c_Pi0,1,1);

  hist1c_SimAdd->SetLineColor(kCyan);
  hist2c_SimAdd->SetLineColor(kCyan);
  hist3c_SimAdd->SetLineColor(kCyan);
  hist4c_SimAdd->SetLineColor(kCyan);
  hist5c_SimAdd->SetLineColor(kCyan);
  ...
  hs4->Add(hist4c_Data);
  hs4->Add(hist4c_Pi0);
  //hs4->Add(hist4c_SimAdd);

  hs5->Add(hist5c_Sim);
  hs5->Add(hist5c_Data);
  hs5->Add(hist5c_Pi0);
  //hs5->Add(hist5c_SimAdd);
