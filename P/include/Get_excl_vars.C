void BDT::Get_excl_vars(TCut cut)
{
  ...
  TH1F *hist1c_Data = new TH1F("hist1c_Data","Data",100,-0.02,0.02);
  TH1F *hist2c_Data = new TH1F("hist2c_Data","Data",100,0,2);
  TH1F *hist3c_Data = new TH1F("hist3c_Data","Data",100,-0.5,0.5);
  TH1F *hist4c_Data = new TH1F("hist4c_Data","Data",100,-1,1);
  TH1F *hist5c_Data = new TH1F("hist5c_Data","Data",100, 0,2);
  TH1F *hist6c_Data = new TH1F("hist6c_Data","Data",100, 0,1);
  ...
  TH1F *hist1c_Sim = new TH1F("hist1c_Sim","MC",100,-0.02,0.02);
  TH1F *hist2c_Sim = new TH1F("hist2c_Sim","MC",100,0,2);
  TH1F *hist3c_Sim = new TH1F("hist3c_Sim","MC",100,-0.5,0.5);
  TH1F *hist4c_Sim = new TH1F("hist4c_Sim","MC",100,-1,1);
  TH1F *hist5c_Sim = new TH1F("hist5c_Sim","MC",100, 0,2);
  TH1F *hist6c_Sim = new TH1F("hist6c_Sim","MC",100, 0,1);
  ...
  hs1->GetHistogram()->GetYaxis()->SetTitle("Counts");
  ...
  hs3->GetHistogram()->GetYaxis()->SetTitle("Counts");
  ...
  hs4->GetHistogram()->GetYaxis()->SetTitle("Counts");
  ...
  hs5->GetHistogram()->GetYaxis()->SetTitle("Counts");
  ...
  hs6->GetHistogram()->GetYaxis()->SetTitle("Counts");
