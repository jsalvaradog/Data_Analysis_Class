...
public:
  ...
  Mbins[63]= TCut("bestCandidateFlag==1 && t_Ph<-0.8 && t_Ph>-100 && strip_Q2 > 5.0 && strip_Q2 < 15.0 && strip_Xbj > 0.55 && strip_Xbj < 1.0 ");
    ...
    DVCS="Training_data_DVCS_ref.root";
    Pi0="Training_data_Pi0_ref.root";
    ...
    epeta = "/work/clas12/jsalvg/Data/eta/RGA/inb/Quality_Data_epeta_NP.root";	
    sim_eta_as_dvcs = "/work/clas12/jsalvg/RGA-Simulation/inb/eta/NP/Quality_eta_as_DVCS_NP.root";
...
theta_gamma_e > 5 && abs(t_Ph/strip_Q2)<1 && mm2_eg > 0";
