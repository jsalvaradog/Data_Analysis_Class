void BDT::eppi0_hists(){
  ...
  TFile *input3 = new TFile("../Quality_Sim_eppi0_NP.root","READ");
  ...
  TH1F *hist3c_Sim = new TH1F("hist3c_Sim","Histogram",100,0,15);
  TH1F *hist9c_Sim = new TH1F("hist9c_Sim","Histogram",100,0.0,0.03);

  TH1F *hist3c_Data = new TH1F("hist3c_Data","Histogram",100,0,15);
