...
public:
  ...
  Rcuts[0]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[1]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[2]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[3]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[4]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[5]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[6]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[7]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");

  Rcuts[8]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[9]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[10]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[11]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[12]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4");
  Rcuts[13]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[14]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[15]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");

  Rcuts[16]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[17]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[18]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[19]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[20]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[21]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[22]= TCut("bestCandidateFlag==1 && abs(delta_Phi)<0.15 && theta_gamma_X<0.6 && abs(delta_t)<0.05");
  Rcuts[23]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.3 && abs(delta_Phi)<0.2 && abs(delta_t)<0.1 && theta_gamma_X<0.6");

  Rcuts[24]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[25]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[26]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[27]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005 ");
  Rcuts[28]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[29]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");
  Rcuts[30]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[31]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");

  Rcuts[32]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");
  Rcuts[33]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[34]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.2 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[35]= TCut("bestCandidateFlag==1 && abs(delta_t)<0.05 && theta_gamma_X<0.5 && miss_mom_eNg<0.1 && abs(delta_Phi)<0.1");
  Rcuts[36]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.18 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[37]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[38]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[39]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");

  Rcuts[40]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.5 && theta_gamma_X<1.0 && abs(mm2_eNg)<0.005");
  Rcuts[41]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<1.0 && abs(mm2_eNg)<0.005");
  ...
  Rcuts[44]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");
  Rcuts[45]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.5 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[46]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[47]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.7");

  Rcuts[48]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.3 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");
  Rcuts[49]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
  Rcuts[50]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.6 && abs(mm2_eNg)<0.005");
  Rcuts[51]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[52]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.7 && abs(mm2_eNg)<0.005");
  Rcuts[53]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.7 && abs(mm2_eNg)<0.005");
  Rcuts[54]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[55]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  ...
  Rcuts[61]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.4 && abs(mm2_eNg)<0.005");
  Rcuts[62]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.8 && abs(mm2_eNg)<0.005");
  Rcuts[63]= TCut("bestCandidateFlag==1 && miss_mom_eNg<0.4 && theta_gamma_X<0.5 && abs(mm2_eNg)<0.005");
    ...
    dir="/work/clas12/jsalvg/RGA-Analysis/inb/P/";
    extBSA="/work/clas12/jsalvg/RGA-Analysis/inb/P/Maxime_BSA/"; //External BSA, from analysis note
    Folder="Analysis/";
    //Folder="Maxime_bins/";
    ...
    //DVCS="/work/clas12/jsalvg/RGA-Simulation/inb/pDVCS/Quality_DVCS_Train.root";    
    Pi0 ="/work/clas12/jsalvg/RGA-Simulation/inb/Pi0/Quality_Pi_as_DVCS.root";
    //DVCS="/work/clas12/jsalvg/RGA-Simulation/inb/pDVCS/Quality_DVCS_Train_smeared.root";    
    //Pi0 ="/work/clas12/jsalvg/RGA-Simulation/inb/Pi0/Quality_Pi_as_DVCS_smeared.root";
    Data="/work/clas12/jsalvg/Data/DVCS/RGA/inb/Quality2_Data_P_gpcorr.root";
    TData="Tested_Quality_Data.root";
    TDVCS="Tested_DVCS.root";
    TPi0="Tested_Pi0.root";

    epeta = "/work/clas12/jsalvg/Data/eta/RGA/inb/Quality_Data_epeta_P.root";	
    sim_eta_as_dvcs = "/work/clas12/jsalvg/RGA-Simulation/inb/eta/P/Quality_eta_as_DVCS_P.root";
    sim_epeta="/work/clas12/jsalvg/RGA-Simulation/inb/eta/P/Quality_Sim_epeta_P.root";
    ...
    theta_gamma_e > 5 && abs(delta_t)<2 && abs(delta_Phi)%180 < 2 && TMath::Sqrt(Xbal * Xbal + Ybal*Ybal + Zbal*Zbal) <1";
